StartupEvents.registry("item",event => {
    event.create('gold_coin').displayName('金币').tooltip('请到任务列表兑换新的货币').rarity('uncommon')
    event.create('diamond_coin').displayName('钻石币').tooltip('请到任务列表兑换新的货币').rarity('epic').glow(true)//发光
